...
import { GET_ALL_COUPONS } from '../../../../redux/actions/coupon'
// **  Components
    ...
    <div className='w-100'>
      <Row>
        ...
        <Col md='5' sm='5'>
          ...
          <Button.Ripple onClick={() => { history.push('/apps/coupon/add') }} color='primary'>
...
const CouponList = () => {
  ...
  const handlePagination = page => {
    dispatch(GET_ALL_COUPONS(page.selected + 1, searchname))
  ...
  const handleSearch = val => {
    ...
    const debounceTimer = setTimeout(() => {
      dispatch(GET_ALL_COUPONS(1, val))
  ...
  useEffect(() => {
    dispatch(GET_ALL_COUPONS(1, searchname))
  }, [])
    ...
    <Fragment>
      <Card>
        <DataTable
          ...
          responsive
          noDataComponent={<div>
            <img src='/Nodatacomponent.png' alt='no data UX' />
          </div>}
          paginationServer
          id='_id'
          columns={columns}
